...
public class Ejerci04 {
	...
	public static void main (String[] args) {
		...
		System.out.println(":::::::Programa para determinar si el numero existe. ::::::::");
		System.out.println("Digite el número ---> :");
		N=entrada.nextInt();
		System.out.println("Digite el numero o digito que desea buscar: ");
		digt=entrada.nextInt();
		...
		do {
			if (cond = true) {
				...
				digt = N % 10;
				X++;
				System.out.println("El digito "+digt+" SI esta en el número ---> :"+N);
				
				}else {
				System.out.println("El digito "+digt+" NO esta en el número ---> :"+N);
				}
