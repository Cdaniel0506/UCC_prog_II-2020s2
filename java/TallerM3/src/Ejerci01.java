...
public class Ejerci01 {
	...
	public static void main (String[] args) {
		...
		System.out.println("__________$$$__________$$$__________$$$__________$$$__________$$$______$$$");
		System.out.println("");
		int ndigi,invertir=0,resto;
		
		System.out.println("Digite cuantos numeros desea colocar: ");
		ndigi=entrada.nextInt();
		
		int [] numero= new int [ndigi];
		
		System.out.println("Digite los numeros a invertir: ");
		...
		System.out.println(" Los numeros a invertir son :");
		for (int i=0;i<ndigi;i++) {
