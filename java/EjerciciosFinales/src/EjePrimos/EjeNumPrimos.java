...
public class EjeNumPrimos {
	...
	public static void main (String[] args) {
		...
		System.out.println("");
		System.out.println("::::::::Programa Numero Primo");
		int aleatorio=0, a=0;
		
		aleatorio = (int)(Math.random() * 1000);
		System.out.println("Se generó un numero aleatorio entre 1 a 1000.");
		...
		if ( a == 2) {
			System.out.println("El numero aleatorio --> "+aleatorio+" es primo.");
		}else {
			System.out.println("El numero aleatorio --> "+aleatorio+" no es primo.");
		}
